...
import MyAccount from './views/management/MyAccount/MyAccount'
import DashboardContent from './views/management/DashboardContent/DashboardContent'
...
const routes = [
  ...
  { path: '/my-account', name: 'My Account', element: MyAccount }
]
