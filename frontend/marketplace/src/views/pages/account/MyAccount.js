...
const MyAccount = () => {
  ...
  const fetchUserInfo = async (userId) => {
    try {
      ...
      console.log('API Response getting data:', response.data);
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await axios.put(`${BASE_URL}/api/users/${userInfo._id}`, {
...
/>
                ...
                <div className="d-flex justify-content-center mb-2">
                  <CButton color="primary">My Wallet</CButton>
                </div>
                <div className="d-flex justify-content-center mb-2">
                  <CButton color="primary">Transaction History</CButton>
                </div>
              </CCardBody>
            </CCard>
          </CCol>
            ...
            <CCard className="mb-4">
              <CCardBody>
                ...
                <CRow>
                  ...
                  <CCol sm="9">
                    <CCardText className="text-muted">{userInfo.phone===""?<span>--------------</span>:userInfo.phone}</CCardText>
                  </CCol>
                </CRow>
                <hr />
                <CRow>
                  ...
                  <CCol sm="9">
                    <CCardText className="text-muted">{userInfo.address===""?<span>--------------</span>:userInfo.address}</CCardText>
                  </CCol>
                </CRow>
              </CCardBody>
            </CCard>
            <CCard className="mb-4">
              <CCardBody>
                ...
                <CForm className="row g-3">
                  <CRow><CCol md={3}>
                    <CFormLabel>New Password</CFormLabel></CCol>
                    <CCol md={6}>
                      <CFormInput
                        type="password"
                  ...
                  <CRow>
                  <CCol md={3}>
                  <CFormLabel>Confirm New Password</CFormLabel></CCol>
                    <CCol md={6}>
                      <CFormInput
                        type="password"
                  ...
                  <CRow>
                    <CCol sm="6">
                      <div className="d-flex justify-content-left mb-2">
                        ...
                        <CButton color="secondary" className="ms-1" onClick={closeEditModal}>Cancel</CButton>
                      </div>
                    </CCol>
                  </CRow>
                </CForm>
